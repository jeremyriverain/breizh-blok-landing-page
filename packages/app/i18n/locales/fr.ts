export default defineI18nLocale(() => {
  return {
    ...
    applicationMockups: "mockups de l'application",
    ...
    featureEasyNavigationDescription:
      "Plusieurs modes de navigation permettent de découvrir le topo de différentes manières (en parcourant une liste, une carte des blocs).",
    featureEasyNavigationTitle: "Plusieurs modes de navigation",
    ...
    featureMapTitle: "Carte intéractive",
    ...
    featureOfflineFirstTitle: "Accès hors-ligne",
    ...
    featureSearchCriteriaTitle: "Trier et filtrer les blocs",
    firstName: "Prénom",
    indexMetaTitle: "Breizh Blok, topo des blocs d'escalade de Bretagne",
    indexDescription:
